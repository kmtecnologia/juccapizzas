<?php
// Criação rota getall.php para listar todas as pizzas cadastradas no banco de dados
...
// try{ colocar para demonstrar erro com coluna errada mas lá no método read em pizza
    ...
    if ($num > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            extract($row);
            // Criar um array associativo para cada pizza
            $pizza_item = array(
                "id" => $idPizza,
                "nome" => $nome,
             ...
             array_push($pizzas_arr, $pizza_item); // Formato associativo para o array de pizzas, ou seja, cada pizza é um array associativo com chaves nome, ingredientes e valor
        }
